...
ActiveRecord::Schema.define(version: 2025_09_03_074135) do
  ...
  create_table "eic_codes", force: :cascade do |t|
    t.string "code"
    t.bigint "consumer_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["consumer_id"], name: "index_eic_codes_on_consumer_id"
  end
